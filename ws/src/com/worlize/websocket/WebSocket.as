...
import flash.net.Socket;
	...
	public class WebSocket extends EventDispatcher
	{
		...
		private static const EMBED_PEM:Class;
...
//			rawSocket = socket = new Socket();
			...
			if (secure) {
				...
				//TODO to review
				var PEM_BA:ByteArray = new EMBED_PEM();
				var CERT_BA:ByteArray = PEM.readCertIntoArray(PEM_BA.readUTFBytes(PEM_BA.bytesAvailable));
				tlsConfig.addTrustedCertificate(CERT_BA);
