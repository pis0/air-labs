...
#define EXTENSION_INIT_DECL(prefix) void (prefix##ExtensionInitializer) (void **extData, FREContextInitializer *ctxInitializer, FREContextFinalizer *ctxFinalizer)
#endif

#ifndef EXTENSION_FIN_DECL
#define EXTENSION_FIN_DECL(prefix) void (prefix##ExtensionFinalizer) (void *extData)
#endif

#ifndef EXTENSION_FIN
#define EXTENSION_FIN(prefix) void (prefix##ExtensionFinalizer) (void *extData) { \
...
#define EXTENSION_INIT(prefix) void (prefix##ExtensionInitializer) (void **extData, FREContextInitializer *ctxInitializer, FREContextFinalizer *ctxFinalizer) { \
