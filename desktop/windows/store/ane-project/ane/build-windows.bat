...
SET AIR_PATH="C:\workspace\_airSDK\bin\"
echo Setting path to current directory to:
SET pathtome=%~dp0
echo %pathtome%

SET projectName=WindowsStore
...
copy %pathtome%..\..\dlls-project\win\%projectName%\x86\Release\%projectName%.dll %pathtome%platforms\win\x86\release
copy %pathtome%..\..\dlls-project\win\%projectName%\x64\Release\%projectName%.dll %pathtome%platforms\win\x64\release

copy %pathtome%..\..\dlls-project\win\%projectName%\x86\Release\%projectName%Lib.dll %pathtome%platforms\win\x86\release
copy %pathtome%..\..\dlls-project\win\%projectName%\x64\Release\%projectName%Lib.dll %pathtome%platforms\win\x64\release
